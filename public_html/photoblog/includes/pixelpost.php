...
// define ("PASSWORD","JCAnYA9EVQKKzQvn");

$pixelpost_db_host      = "localhost"; // database host, often "localhost"
// $pixelpost_db_user      = "gel6968"; // database user
$pixelpost_db_user      = "root"; // database user
// $pixelpost_db_pass      = "hat817berg"; // database user password
$pixelpost_db_pass      = "8UULkz7WR3"; // database user password
// $pixelpost_db_pixelpost = "gel6968_pp"; // database
